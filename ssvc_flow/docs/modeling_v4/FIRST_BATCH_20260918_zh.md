...
- 串行作业159870于2026-09-18 15:00:09 UTC按用户要求结束。
- 已提交的第一题work包64条样本保留；切换前后检查的7个已提交文件均保持原元数据和文件状态。
- worker0：作业**159879**，15:01:03 UTC启动，节点gpu-pro6000-5，题号0/2/4。
- worker1：作业**159880**，15:01:05 UTC启动，节点gpu-pro6000-7，题号1/3/5。
- 两作业均核实RUNNING，账户rose、QoS soujanya-poria-startfund-2026-03，各gpu:pro6000:1。
- 启动器提交4ea2c46；实际测量仍使用0002af0部署的冻结src和原PLAN，已提交样本可恢复。
- 每小时只读监控已切换到LAUNCH_PARALLEL.json中的两个作业；任意一道题首次完成时通知，不要求题号0最先完成。
