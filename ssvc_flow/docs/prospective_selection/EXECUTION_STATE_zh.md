...
2026-09-25T08:42Z：170518(R4)/170520(SAW_R4)完整32步训练与H8/H32独立评估均通过原始证据复核，COMPLETED/0:0，总耗时06:39:30/06:40:51，D J=0.7677951389/0.7699652778。证据见current_evidence/BRANCH_R4_SAW_VERIFIED_20260925.json。首四条branch已完成4/88，全部仍只来自61001_t32；不构成未见原点上的方法优越结论。四个完整branch耗时均值6.570 GPU小时，MEASURED_RUNTIME_zh.md已追加更新。

已补位170929=61001_t96/R7、170930=61001_t96/R4（repeat1），首次PENDING，五卡队列另含170853(R1)、170863(R5)、170771(61003_t32前置观测)。08:41Z前置观测61003_t32的t24完成67/72，t32尚无完成提示；前置观测整体完成2/8、旧E完成2/16。所有运行作业继续原协议与相同前置样本/候选集合，无FIRST_FOUR_DELIVERED、无扩展、无最终测试。


2026-09-25T11:46Z：170771（61003_t32前置观测）COMPLETED/0:0，耗时04:20:05；4608条原始输出、小文件绑定、汇总重算及四层共同信息包重建核验通过，见current_evidence/PRESTATE_61003_t32_VERIFIED.json。P J24=0.6653645833、J32=0.7178819444，仅为前置状态描述，不是选择器收益。前置观测已完成3/8，完整branch仍4/88、旧E仍2/16。

已补入171054=61002_t32前置观测（source R1），任务键6ee79086abbfb09b140668e400874d639920c0ae090b51a3b6828a3a41d926c1，服务器回执LAUNCH_20260925_1146.json；现场确认RUNNING。其它四个分支170853/170863/170929/170930更新分别22/22/22/21步，权威恢复段均到16步，已见更新数值有限且尾部日志无异常，未知提交错误0。项目共5个单PRO6000作业，保持教师QOS；无首四条交付、无扩展、无最终测试。


2026-09-25T15:52Z：61001_t96的R1/R5/R7/R4（170853/170863/170929/170930）均COMPLETED/0:0，H32 D J分别0.7873263889/0.7860243056/0.7864583333/0.7881944444，总耗时07:46:53/07:55:34/06:09:10/06:23:42。共4096训练输出、128有限更新、9984个H8/H32评估输出完成轻量绑定与汇总复算核验，见current_evidence/BRANCH_T96_FIRST4_VERIFIED_20260925.json。四臂共享分支初态；分支重置续训采样器与步数元数据，因此初态hash不能直接等同source H96 hash，审计时已按run_branch源码核对，未修改实验代码或重跑。

首批branch完成8/88，来自同一lineage的t32/t96两个相关原点；t96四臂端点最大差0.00217014，仅为开发描述，尚无完整R0对照与跨lineage选择器证据，不据此删臂或改目标。八个完整branch总耗时均值6.817 GPU小时，见MEASURED_RUNTIME_zh.md。前置观测仍3/8、旧E2/16，首四条未交付。

四个已核验槽位补入61003_t32的R3/R1/GDPO_R4/R7：171305/171306/171307/171308，服务器回执LAUNCH_20260925_1552.json，现场全部RUNNING。另有171054=61002_t32前置观测，15:52Z完成137/144个提示，无COMPLETE；当前5个单PRO6000教师QOS作业，未知提交错误0。不扩展lineage，不运行最终测试。


2026-09-25T16:50Z：171054（61002_t32，source R1）COMPLETED/0:0，耗时04:17:18；4608条原始输出、样本绑定、汇总重算和四层共同信息包核验通过，回执current_evidence/PRESTATE_61002_t32_VERIFIED.json。P J24=0.6241319444、J32=0.671875，仍只是前置状态描述。当前prestate4/8、完整branch8/88、旧E2/16，首四条完整交付尚未满足。

释放槽位提交171346=61004_t96前置观测（source R1），任务键bbfc472877f533c7a8c846a88b76bb6f5708b04cf9ae5e56743823299beb1f36，服务器回执LAUNCH_20260925_1650.json。16:50Z状态PENDING，原因为ReqNodeNotAvail, Reserved for maintenance；保留原提交等待，不重提或切换QOS。其它171305–171308四个分支仍RUNNING，均已见5步有限更新、尚无8步权威段，日志无异常。当前4运行+1等待计为5个项目GPU作业，未知提交错误0。未扩展lineage、未运行最终测试。


2026-09-26T05:40Z网络恢复：171305/171306/171307/171308（61003_t32的R3/R1/GDPO_R4/R7）均于09-25T23:27–23:31Z正常结束，COMPLETED/0:0，分别耗时07:40:15/07:38:08/07:38:27/07:35:59。4096训练输出、128有限更新、9984个H8/H32评估原始输出、共同分支初态和全部轻量绑定核验通过，回执current_evidence/BRANCH_61003_T32_FIRST4_VERIFIED_20260926.json。D J分别0.7712673611/0.7647569444/0.7725694444/0.7690972222；仅为开发端点描述，完整R0对照仍未齐，不能判断选择器优劣。累计branch12/88，prestate4/8、旧E2/16。十二分支平均7.090 GPU小时。

当前无项目GPU作业运行。维护预留覆盖所有节点：UTC 2026-09-26T16:00至09-27T13:00（新加坡09-27 00:00–21:00），默认24小时时限已无法容纳在维护前窗口。尝试将既有等待前置观测171346缩为8小时，被站点明确拒绝：slurm_job_submit: Updating TimeLimit is not allowed；其TimeLimit仍1-00:00:00，未取消或重提。证据见current_evidence/MAINTENANCE_QUEUE_20260926.json。不能把网络恢复写成训练已恢复，也不能把维护结束时间当作保证开跑时间。

四个通过核验的槽位已由原持久队列补入61002_t32的R0/R2/R7/R1：171705/171706/171707/171708，服务器回执LAUNCH_20260926_0540.json。连同171346=61004_t96前置观测，共5个PENDING，均ReqNodeNotAvail, Reserved for maintenance；未知提交错误0，未改QOS或型号。后续按这些当前ID复核，不重复提交；首四条未交付、未扩展、未冻结或运行最终测试。
