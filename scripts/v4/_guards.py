...
def _load_config(path: Path) -> dict[str, object]:
    ...
    expected_cache_parity = {
        ...
        "require_exact_generated_logits": False,
        "require_stepwise_argmax_parity": True,
        "require_realized_token_top1": True,
        "report_stepwise_logit_drift": True,
        "continue_after_call_level_token_divergence": True,
        "report_token_divergence_evidence": True,
        "exclude_token_divergent_calls_from_i4_primary": True,
