#!/usr/bin/env python3
"""Fail-closed server entry for the pre-training v5 orbit audit."""
...
ACK = "I_UNDERSTAND_THIS_RUNS_V5_ORBIT_AUDIT"
...
def main() -> int:
    ...
    runner(
        ...
        {"task": "orbit_audit", "k": arguments.k, "pilot": "single_gpu_4090"},
    )
    return 0
