#!/usr/bin/env python3
"""Fail-closed server entry for post-LoRA structural-support measurement."""
...
ACK = "I_UNDERSTAND_THIS_RUNS_V5_ORBIT_SUPPORT_EVALUATION"
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", type=Path, default=OUTPUT_ROOT / "orbit_support.json")
...
def main() -> int:
    ...
    if arguments.fixture_dry_run:
        if arguments.execute:
            ...
            return 2
        result = evaluate_structural_support(structural_support_fixture(), k=arguments.k)
    ...
    runner(
        ...
        {"task": "orbit_support", "k": arguments.k, "pilot": "single_gpu_4090"},
    )
    return 0
